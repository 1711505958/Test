...
insert  into `chuku`(`chuku_id`,`shop_name`,`shop_fenlei`,`chuku_shuliang`,`chuku_date`) values (1,'片片虾','鱼类',10,'2018-12-17'),(2,'片片虾','鱼类',2,'2018-12-17'),(3,'片片虾','鱼类',1,'2018-12-19'),(4,'牛肉','肉类',10,'2018-12-20'),(5,'小龙虾','鱼类',5,'2018-12-21');
...
insert  into `ruku`(`ruku_id`,`shop_name`,`shop_fenlei`,`ruku_shuliang`,`ruku_data`) values (1,'片片鱼','鱼类',10,'2018-12-19'),(2,'片片虾','鱼类',10,'2018-12-19'),(3,'联想台式机','家电',10,'2018-12-19'),(4,'片片鱼','鱼类',10,'2018-12-19'),(5,'片片鱼','鱼类',11,'2018-12-19'),(6,'片片虾','鱼类',20,'2018-12-19'),(7,'牛肉','肉类',20,'2018-12-19'),(8,'小龙虾','鱼类',10,'2018-12-19'),(9,'鲤鱼','鱼类',10,'2018-12-21'),(10,'小鱼仔','辣条',20,'2018-12-21'),(11,'小白菜','蔬菜类',20,'2018-12-21'),(12,'秋刀鱼','鱼类',10,'2018-12-25');
